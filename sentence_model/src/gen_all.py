...
def main() -> int:
    ...
    print("=" * 70)
    print()
    print("Generated files (production - bincode):")
    print("  - ../assets/data/trial/ranks_qa.bin")
    print("  - ../assets/data/trial/ranks_aq.bin")
    print("  - ../assets/data/trial/ranks_qq.bin")
    print("  - ../assets/data/trial/ranks_rr.bin")
    print("  - ../assets/data/trial/corpus_r.toml (updated with scores)")
    print()
    print("Debug files (txt format):")
    print("  - debug_output/ranks_qa.txt")
    print("  - debug_output/ranks_aq.txt")
    print("  - debug_output/ranks_qq.txt")
    print("  - debug_output/ranks_rr.txt")
    print()
